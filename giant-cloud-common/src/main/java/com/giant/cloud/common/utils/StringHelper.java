package com.giant.cloud.common.utils;
...
//		String s = "   sss            ssss          sss";
//		s = s.replaceAll("\\s+", " ");
//    	System.out.println(getStrRemoveHtmlTag(s));
    	String string="";
    	System.out.println(isNotEmpty(string));
	}
